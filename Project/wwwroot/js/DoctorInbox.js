...
var DoctorName = "";
var PatientName = "";
function sendMessage(DoctorId,PatientId) {
    connection.invoke("LoadChatForDoctor", DoctorId, PatientId).catch(err => console.error("Error calling LoadChatFunctionDoctor:", err));
}
